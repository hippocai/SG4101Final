 ...
 *
 */
public class ClientMainCalendar extends JPanel{
    ...
    private ClientMainCalendar(java.util.Date date, String format, int startDAY){
    ...
    public static ClientMainCalendar getInstance(java.util.Date date, String format){
        return new ClientMainCalendar(date, format, defaultStartDAY);
    }

    public static ClientMainCalendar getInstance(java.util.Date date){
        return getInstance(date, DEFAULTFORMAT);
    }
    public static ClientMainCalendar getInstance(String format){
        return getInstance(new java.util.Date(), format);
    }
    public static ClientMainCalendar getInstance(){
    ...
    private class LabelManager {
        ...
        public LabelManager(){
            list = new ArrayList<ClientMainCalendar.DayLabel>();
        }
