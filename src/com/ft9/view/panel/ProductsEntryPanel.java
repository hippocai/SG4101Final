 ...
 * class description: When Products Under Threshold, Add New Product <BR>
 * Remark: <BR>
 * @version 1.00
 * @author Guo Qi
 */
...
public class ProductsEntryPanel extends javax.swing.JPanel {
   ...
   public ProductsEntryPanel(ProductBean productBean,int _type) throws ServiceNotFoundException {
	   productService=(ProductService)ServiceManager.getService("Product");
       initComponents();
...
private void setDatas(){
     ...
     * Description: Init Components In ProductsEntryPanel <BR>
     * Remark: <BR>  void<BR>
     */
     ...
     * Description: Clear All Text Fields <BR>
     * Remark: <BR>  void<BR>
     */
     ...
     * Description: Check And Get The Inputs <BR>
     * Remark: <BR>
     ...
     * Description: Check If The Inputs Are Interger <BR>
     * Remark: <BR>
     * @return  boolean<BR>
     */
